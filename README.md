...
- **วิดเจ็ตแยกชิ้น (Phase 8):** `?w=all` (ครบ, ค่าเริ่มต้น) หรือเลือกเฉพาะ `alert` / `leaderboard` / `goal` (หลอดเป้าหมายเดือนนี้ อัปเดตสด) / `recent` (กำลังใจล่าสุด 5 รายการ) — วางมุมจอด้วย `&pos=tl|tr|bl|br` เพิ่มหลาย Browser Source ได้
...
- **สถานะออนไลน์:** overlay ping ทุก 10 วิ — Dashboard บนสุดแสดง 🟢 OBS ออนไลน์ / 🔴 ออฟไลน์ (หลุด 30 วิ = ออฟไลน์)
...
- **Dashboard 5 แท็บ:**
  - *ภาพรวม* — ยอดวันนี้/เดือนนี้/รวม/จำนวนครั้ง + กราฟ 30 วัน + แถบความคืบหน้าเป้าหมาย + **พรีวิวสด Alert ในหน้าเดียว** + pill สถานะ OBS
  ...
  - *ตั้งค่า* — **บัญชีรับเงินโอนตรง (เบอร์พร้อมเพย์ 10/13 หลัก + QR ทดสอบสแกนได้จริง)**, ธีม overlay, เป้าหมาย, ระยะเวลาป็อบอัพ, TTS, ข้อความแจ้งเตือน, อัปโหลดเสียง, รูป/GIF, ตาราง URL วิดเจ็ตแยกชิ้น + **หน้าโดเนตของฉัน (ธีม 4 แบบ / รูปปก / เกี่ยวกับฉัน / ลิงก์โซเชียล 5 ช่อง พร้อมพรีวิว)**
